...
const Skills = () => {
  return (
    <div id="skills" className="my-20 items-center justify-center flex flex-col ">
      <div className="flex items-center flex-col justify-center md:flex-row py-2">
        <h3 className="itemx-center text-center">Front-end skills:</h3>
        <div className="flex ">
          <Image
            src={html}
        ...
        <div className="flex ml-5 items-center flex-col text-center justify-center md:flex-row">
